    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row '>
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
          ...
          libero
          illum ipsum sint ab maxime quos provident consectetur aliquid eius.
        </p>
      ...
      <div className='relative flex flex-1 items-start'>
        ...
        rounded-3xl bg-green-90 px-7 py-8'>
          ...
          <div className="flex flex-col" >
            ...
            <p className='bold-20 text-white'>Agus Callientes</p>
          </div>

          <div className="flexBetween">
            <div className='flex flex-col'>
              <p className='regular-16 block text-gray-20'>Distance</p>
              <p className='bold-20 text-white'>152.29 mi</p>

            </div>
            <div className='flex flex-col'>
              <p className='regular-16 block text-gray-20'>Elevation</p>
              <p className='bold-20 text-white'>2.028 km</p>
