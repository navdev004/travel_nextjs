...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
  return (
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage}
       bg-cover bg-no-repeat rounded-5xl 2xl:rounded-5xl`}>
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'>
          ...
          <p className='regular-14 xl:regular-16 mt-5 text-white'>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
             Commodi amet veritatis animi possimus recusandae nulla voluptatibus fuga, totam illo accusantium molestiae cupiditate nam! 
            Eligendi voluptatum maiores voluptatibus, obcaecati cum laboriosam!
          </p>
          <Image
           src={"/quote.svg"}
           alt='camp-2'
