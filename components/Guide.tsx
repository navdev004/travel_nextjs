      ...
      max-container w-full pb-24'>
        ...
        <div className='flex flex-wrap justify-between gap-5 lg:gap-10'>
          ...
          <p className='regular-16 text-gray-30 xl:max-w-[520px]'>
            ...
            Ipsam, rerum excepturi? Obcaecati nemo, impedit voluptas corporis
             animi velit voluptatem, in, Obcaecati nemo, impedit
             beatae voluptate unde rerum. Harum deserunt f voluptas corporis
             animi velit voluptatem, in, 
            beatae voluptate unde rerum. Harum deserunt fuga non dolor! Corrupti!
          </p>
        </div>
      </div>
